...
<section id="gost" class="">
    <div class="container-fluid">
        <div class="row row_960">
            ...
            <div class="content">
                <p class="desc">НОВАЯ МОДЕЛЬ - "Теплица ГОСТ" с усиленным каркасом</p>
                <div class="l">
                ...
                <div class="r">
                    <ul>
                        <li>Соответствует ГОСТ РБ и РФ</li>
                        <li>Высота - 2м, ширина - 3м</li>
                        <li>Оцинкованный профиль, двойная дуга, сечение трубы 20х20</li>
                        <li>Система крепления "краб"</li>
            ...
            <div class="mobile-content">
                <p class="mobile-title">Новая модель - "Теплица ГОСТ" с усиленным каркасом</p>
    ...
    <div class="container-fluid">
        <div class="row row_960">
            ...
            <div class="ocenka">
                ...
                <div class="text">
                    *Нас оценили 1812 клиентов в <?php echo $year;?> году
                </div>
            </div>
            <div class="catalog_cont">
                <!-- БелТеплица-Старт -->
                <div class="product product1">
                    <p class="pr_title">Теплица «БелТеплица-Стандарт»</p>
                    <div class="product-img">
                        <img src="images/catal/start1.jpg" alt="">
                ...
                <div class="product product2">
                    <p class="pr_title">Теплица «БелТеплица-Народная»</p>
                    <div class="product-img">
                        <img src="images/catal/lider1.jpg" alt="">
                        <div class="count few">Осталось 4 шт.</div>
                        <!-- <div class="luchsh">
                            от 16 300 руб.
                        </div> -->
                    </div>
                ...
                <div class="product product3">
                    <p class="pr_title">Теплица «БелТеплица-Традиционная»</p>
                    <div class="product-img">
                        <img src="images/catal/ultra1.jpg" alt="">
                        <div class="count">Осталось 24 шт.</div>
                        <!-- <div class="luchsh">
                            от 17 500 руб.
                        </div> -->
                    </div>
                ...
                <div class="product product4">
                    <p class="pr_title">Теплица «БелТеплица-Компакт»</p>
                    <div class="product-img">
                        <img src="images/catal/compact1.jpg" alt="">
                        <div class="count">Осталось 28 шт.</div>
                        <!-- <div class="luchsh">
                            от 14 800 руб.
                        </div> -->
                    </div>
                    <div class="desc" data-toggle="modal" data-target="#catalog-form">
                        <ul>
                            <li>
                                <nobr>ширина – 2,04 м,</nobr> <nobr>высота – 2 м,</nobr> длину выбираете сами <nobr>(от 4 до 12 м)</nobr>
                            </li>
                            <li>
                                стальная труба оцинкована полностью с наружной и с внутренней стороны <nobr>20х20мм</nobr>
                            </li>
                ...
                <div class="product product5">
                    <p class="pr_title">Теплица «БелТеплица-Мини»</p>
                    <div class="product-img">
                        <img src="images/catal/mini1.jpg" alt="">
                        <div class="count">Осталось 32 шт.</div>
                        <!-- <div class="luchsh">
                            от 13 200 руб.
                        </div> -->
                    </div>
                ...
                <div class="product product6">
                    <p class="pr_title">Теплица «БелТеплица-Капелька»</p>
                    <div class="product-img">
                    ...
                    <div class="desc" data-toggle="modal" data-target="#catalog-form">
                        <ul>
                            <li>
                                <nobr>ширина – 3 м,</nobr> <nobr>высота – 2,4 м,</nobr> длину выбираете сами <nobr>(от 4 до 12 м)</nobr>
                            </li>
                            <li>
                ...
                <div class="product horizont">
                    <p class="pr_title">Теплица «БелТеплица-Советская»</p>
                    <div class="leftPart">
                        <div class="product-img">
                            <img src="images/catal/triumf1.jpg" alt="">
                            <div class="desc" data-toggle="modal" data-target="#catalog-form">
                                <ul>
                                    ...
                                    <li>стальная труба оцинкована полностью с наружной и с внутренней стороны 40х20мм</li>
    ...
    <div id="catalog-mobile">
        <div class="product">
            ...
            <a href="#" class="product-img">
                <img src="images/catal/start1.jpg" alt="">
                <div class="count">Осталось 23 шт.</div>
                <!-- <div class="luchsh">от 15 800 руб.</div> -->
            </a>
        ...
        <div class="product">
            <p class="pr_title">Теплица «БелТеплица-Народная»</p>
            <a href="images/catal/lider1.jpg" class="product-img">
                <img src="images/catal/lider1.jpg" alt="">
                <div class="count few">Осталось 4 шт.</div>
                <!-- <div class="luchsh">от 16 300 руб.</div> -->
            </a>
            <div class="desc" data-toggle="modal" data-target="#mobile-catalog-form">
                <ul>
                    <li>ширина – 3 м, высота – 2 м, длину выбираете сами (от 4 до 12 м)</li>
        ...
        <div class="product">
            <p class="pr_title">Теплица «БелТеплица-Традиционная»</p>
            <a href="images/catal/ultra1.jpg" class="product-img">
                <img src="images/catal/ultra1.jpg" alt="">
                <div class="count">Осталось 24 шт.</div>
                <!-- <div class="luchsh">от 17 500 руб.</div> -->
            </a>
            <div class="desc" data-toggle="modal" data-target="#mobile-catalog-form">
                <ul>
                    <li>ширина – 3 м, высота – 2 м, длину выбираете сами (от 4 до 12 м)</li>
        ...
        <div class="more collapse" id="more">
            <div class="product">
                <p class="pr_title">Теплица «БелТеплица-Компакт»</p>
                <a href="images/catal/compact1.jpg" class="product-img">
                    <img src="images/catal/compact1.jpg" alt="">
                    <div class="count">Осталось 28 шт.</div>
                    <!-- <div class="luchsh">от 14 800 руб.</div> -->
                </a>
                <div class="desc" data-toggle="modal" data-target="#mobile-catalog-form">
                    <ul>
                        <li>ширина – 2,04 м, высота – 2 м, длину выбираете сами (от 4 до 12 м)</li>
                        <li>стальная труба оцинкована полностью с наружной и с внутренней стороны 20х20мм</li>
                        <li>расстояние между дугами 1 м</li>
                        <li>новое поколение поликарбоната 4мм</li>
                        <li>двойная защита от ультрафиолета</li>
            ...
            <div class="product">
                <p class="pr_title">Теплица «БелТеплица-Мини»</p>
                <a href="images/catal/mini1.jpg" class="product-img">
                    <img src="images/catal/mini1.jpg" alt="">
                    <div class="count">Осталось 32 шт.</div>
                    <!-- <div class="luchsh">от 13 200 руб.</div> -->
                </a>
                <div class="desc" data-toggle="modal" data-target="#mobile-catalog-form">
                    <ul>
            ...
            <div class="product">
                ...
                <div class="desc" data-toggle="modal" data-target="#mobile-catalog-form">
                    <ul>
                        <li>ширина – 3 м, высота – 2,4 м, длину выбираете сами (от 4 до 12 м)</li>
            ...
            <div class="product">
                ...
                <a href="#" class="product-img">
                    <img src="images/catal/triumf1.jpg" alt="">
                    <!-- <div class="count">от 20 500 руб.</div> -->
                </a>
                <div class="desc" data-toggle="modal" data-target="#mobile-catalog-form">
                    <ul>
                        <li>В усиленную комплектацию входят (дополнительно к базовой компл.):
